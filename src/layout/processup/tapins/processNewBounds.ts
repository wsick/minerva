module minerva.layout.processup.tapins {
    export var processNewBounds: IProcessUpTapin = function (input: IInput, state: IState, output: IOutput, vo: IProcessVisualOwner): boolean {
