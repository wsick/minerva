module minerva.controls.border.render.tapins {
    export function calcInnerOuter (input: IInput, state: IState, output: layout.render.IOutput, ctx: layout.render.RenderContext, region: Rect, tree: layout.IUpdaterTree): boolean {
