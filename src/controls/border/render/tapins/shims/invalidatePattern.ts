module minerva.controls.border.render.tapins.shim {
    export function invalidatePattern (input: IInput, state: IShimState, output: layout.render.IOutput, ctx: layout.render.RenderContext, region: Rect, tree: layout.IUpdaterTree): boolean {
